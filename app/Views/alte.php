              ...
              <div class="card-body">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="direct-chat-img" src="<?php echo base_url();?>/public/assets/dist/img/user1-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="direct-chat-img" src="<?php echo base_url();?>/public/assets/dist/img/user7-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="direct-chat-img" src="<?php echo base_url();?>/public/assets/dist/img/user3-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="direct-chat-img" src="<?php echo base_url();?>/public/assets/dist/img/user5-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="direct-chat-img" src="<?php echo base_url();?>/public/assets/dist/img/user6-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="direct-chat-img" src="<?php echo base_url();?>/public/assets/dist/img/user8-128x128.jpg">
